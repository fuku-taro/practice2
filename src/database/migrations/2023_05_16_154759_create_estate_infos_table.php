...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('estate_infos', function (Blueprint $table) {
            ...
            $table->timestamp('build_date')->nullable()->comment('日付');
            $table->string('land_extention', 30)->nullable()->comment('敷地延長');
            
            $table->string('location1', 255)->nullable()->comment('所在地名1');
            $table->string('location2', 255)->nullable()->comment('所在地名2');
            $table->string('address', 255)->nullable()->comment('番地');
            ...
            $table->string('child_school', 30)->nullable()->comment('学区(小学校)');
            $table->string('middle_school', 30)->nullable()->comment('学区(中学校)');
            $table->string('price', 10)->nullable()->comment('価格');
            ...
            $table->string('build_year', 30)->nullable()->comment('築年月(年)');
            $table->string('build_mounth', 30)->nullable()->comment('築年月(月)');
            $table->string('floor_plan', 30)->nullable()->comment('間取り');
            ...
            $table->string('current_situation', 30)->nullable()->comment('現況');
            $table->string('delivery_time', 30)->nullable()->comment('引渡し可能時期');
